...
namespace TakeAway.Catalog.Services.ProductServices
{
    public class ProductService : IProductService
    {
        ...
        {
            var values = await _productColletion.Find<Product>(x => x.ProductId == id).FirstOrDefaultAsync();
        ...
        public async Task UpdateProductAsync(UpdateProductDto updateProductDto)
        {
            ...
            await _productColletion.FindOneAndReplaceAsync(x => x.ProductId == updateProductDto.ProductId, values);
        }
    }
}
